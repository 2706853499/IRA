...
if __name__ == "__main__":
    ...
    parser.add_argument("--policy", default='IRA')
    ...
    parser.add_argument("--action_buffer_size", type=int, default=2e5)
    parser.add_argument("--warmup_timestamps", type=int, default=4000)
    ...
    if args.policy == "IRA":
        ...
        kwargs["mu"] = args.mu
        kwargs["k"] = args.k
        kwargs["action_buffer_size"] = args.action_buffer_size
        kwargs['warmup_timestamps'] =args.warmup_timestamps
        policy = IRA.IRA(**kwargs)
    elif args.policy == "IRA(DDPG)":
        kwargs["alpha"]=args.alpha
        kwargs["mu"] = args.mu
        kwargs["k"] = args.k
        kwargs["action_buffer_size"] = args.action_buffer_size
        kwargs['warmup_timestamps'] =args.warmup_timestamps
        policy = IRA_DDPG.IRA_DDPG(**kwargs)
    # Initialize policy
